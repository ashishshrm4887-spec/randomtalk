...
async function startLocalMedia() {
  ...
  try {
    ...
    addSystemMessage(
      "⚠️ Camera or microphone permission was denied."
    );
...
window.addEventListener(
  ...
  () => {
     ...
     * User must press Start Chatting.
     */
